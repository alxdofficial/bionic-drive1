...
from modules.model_mistral import DriveT5VisionModel
...
if __name__ == '__main__':
    ...
    model= torch.load(
        "multi_frame_results/20241020-161051/latest_model_6.pth"
    )
    ...
    test_dloader = DataLoader(test_dset, shuffle=True, batch_size=1, drop_last=True,
                              collate_fn=test_dset.test_collate_fn)
